...
詳細は下記の「QGIS Serverをインストールする場合には、次のコマンドを入力します:」を参照  
 https://qgis.org/ja/site/forusers/alldownloads.html  
...
#### 3-2.[QGIS-Plugin-Manager](https://docs.lizmap.com/current/en/install/pre_requirements.html#qgis-server-plugins)のインストール  
---
...
#QGIS pluginの各アプリインストール先  
#FcgidInitialEnv QGIS_PLUGINPATH /var/www/lizmap-plugins  
mkdir /var/www/lizmap-plugins  
#各プラグインのインストール先
cd /var/www/lizmap-plugins  
