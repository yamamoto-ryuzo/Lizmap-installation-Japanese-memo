...
### step-4
##### (step4-初めてのインストール lizmap-fcgi.conf　の作成) 
...
#今回は3.6.5として作成、実際にはそれぞれの **バージョン** を記入のこと  
...
##### (step4-アップデート　lizmap-fcgi.confの修正)  
